...
const handleClick = () => {
  ...
  return (
    ...
    <button aria-label='Click to favorite' onClick={() => handleClick()} className={classNames('w-full flex flex-row gap-3 rounded-lg bg-slate-700 border-2 p-2 cursor-pointer transition-colors', {
    ...
    <img src={course.instructor_image_url} alt={course.instructor_name} className='rounded-lg size-30'/>
